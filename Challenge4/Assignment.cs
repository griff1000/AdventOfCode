namespace Challenge4
{
    internal class Assignment
    {
        ...
        public bool IsOverlap => FirstElfSections.Any(f => SecondElfSections.Contains(f));
        public bool OneContainedInOther => SecondElfSections.All(s => FirstElfSections.Contains(s)) 
